...
export default function App() {
  ...
  const stats = useMemo(() => {
    ...
    // Ganancia Mensual (Solo lo que generan los perfiles actualmente activos)
    const gananciaMensual = activos.reduce((acc, c) => acc + ((parseFloat(c.precioVenta)||0) - (parseFloat(c.precioCompra)||0)), 0);
